...
Tap the camera icon for a **full-quality** photo. It takes a little longer than a fast image but gives you the clearest view. See [Taking higher quality images](taking-higher-quality-images.md).
...
* [Taking higher quality images](taking-higher-quality-images.md)
* [Deleting an Image](../getting-started/app/deleting-an-image.md) — the trash icon (bottom right)
* [Seeing Camera view](seeing-camera-view.md)
