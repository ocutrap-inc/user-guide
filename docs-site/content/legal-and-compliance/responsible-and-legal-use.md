---
description: >-
  Trapping and relocating wildlife is regulated and varies by location. Know
...
Trapping animals is regulated almost everywhere, especially **moving or releasing them somewhere else**. Before you deploy a trap, check with your **local wildlife or fish-and-game authority**.
...
OcuTrap's target weight range (**5 to 25 lb**) overlaps with domestic cats and small dogs. If you trap a pet, **release it promptly** and, if it's identifiable, let the owner know. Consider this when choosing where and when to arm your trap.
