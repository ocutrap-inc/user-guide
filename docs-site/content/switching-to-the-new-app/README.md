...
{% hint style="info" %}
If a trap shows as unsubscribed, or a plan you expect isn't listed on your account Billing page, **don't start a new subscription.** [Contact support](../support/support.md) and we'll reconcile it — you won't be double-charged.
{% endhint %}
