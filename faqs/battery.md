...
**Battery packs**: Each pack provides 12V power.
...
3. **Charging Duration**:
   * If the battery is **completely drained**, it will take approximately **5 to 6 hours** to fully charge.
4. **Disconnecting**:
...
* **Capacities**: **5,200 mAh (56 Wh)** or **10,000 mAh (111 Wh)**. Both are 12 V, 6-cell packs. Tell the app which pack you have under **Settings → Battery Type** so low-battery alert thresholds match automatically.
...
Follow these charging steps to protect battery performance and life. If you have an issue, contact [support@ocutrap.com](mailto:support@ocutrap.com).
