...
The OcuTrap R2 and R1 are built for **medium-sized nuisance wildlife**, animals roughly **5 to 25 lbs** that fit comfortably inside the cage. This page covers which species fit well and which are a poor match.
...
* **Skunks:** sized well for the cage. The remote door control is especially useful here: you can manage the trap [from the app](../getting-started/app/trap-control.md) without startling the animal up close.
...
| Fit | Animals | Notes |
| --- | --- | --- |
| **Comfortable fit** | Raccoons, feral/stray cats, skunks, opossums (~5 to 25 lbs) | Enough room to fully enter and reach bait placed behind the sensor |
...
These animals are a poor match for the trap:
