---
description: >-
  Find the main and advanced settings for notifications, capture distance,
...
Adjust these settings for each trap. Changes apply when the trap is connected, usually in about 1-5 minutes.
