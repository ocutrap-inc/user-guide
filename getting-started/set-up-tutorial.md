---
description: >-
  From unboxing to your first armed trap — every step in order, with links to
...
The full field guide — placement, capture-distance tuning, the pre-departure checklist, and validating with [Scouting Mode](app/scouting-mode.md):
