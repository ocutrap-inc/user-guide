...
* OcuTrap's detection is designed to be **selective**, but no system is perfect — be prepared to release animals you didn't intend to catch. See [Handling & Releasing a Captured Animal](../getting-started/handling-a-captured-animal.md).
