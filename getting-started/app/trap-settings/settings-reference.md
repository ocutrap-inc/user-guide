...
| **EDC Backoff** | 30–130 ms (10 ms steps) | 85 ms | How far the door backs off during Enhanced Door Closing. Lower it if the door reverses too far on a fresh battery. Raise it if the lock rod never drops. Needs firmware v2.3.2-1010+. |
