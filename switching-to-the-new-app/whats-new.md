...
description: >-
  ...
  one. It covers the same features, with a few renamed screens and controls.
---

# What's new: old app vs. new app

You can still do everything from the old app in the new one. A few things have clearer names or live on a different screen. Use this page as a quick translation guide.
...
* Notifications still come from your trap's own firmware. The app delivers and labels them.
* Your capture history and images all came across with you.

Still have a question? **[Contact support](../support/support.md)**.
