...
| Lock settings so only the owner can change them | ✅ | ❌ | ❌ |
| Add or remove other managers | ✅ | ✅ | Only if granted |
| Delete the trap | ✅ | ❌ | ❌ |
| Transfer ownership | ✅ | ❌ | ❌ |
| Manage subscription and billing | ✅ | ❌ | ❌ |

¹ A manager cannot change settings that the owner has locked.

## Managing access

Access can be revoked by the owner (or a manager who has user-management permission) at any time. A shared invite stays **Pending** until the recipient accepts it from their email; until then they have no access to the trap. See [Sharing Traps](README.md) for the step-by-step sharing flow.
