...
The camera view is built right into the trap's detail screen — the most recent image from inside your trap is shown as a large photo next to the trap's controls. There's no separate step to open it.
