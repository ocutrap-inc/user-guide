---
description: >-
  Move from base.ocutrap.com to the new OcuTrap app, set your password, and
...
* **Same email as before.** Your traps, shared access, and subscription are attached to the email you used with the old app. Sign in with that address.

{% hint style="info" %}
**Prefer your phone?** The new OcuTrap app is available for [iPhone and iPad](https://apps.apple.com/app/id1539244938) and [Android](https://play.google.com/store/apps/details?id=com.ocutrap.ocutrap). Download it, then sign in with the same email and the password you just set.
{% endhint %}
...
Your subscription moved with your traps with the same plan, price, renewal date, and payment method. There's no new checkout and nothing to re-enter. To confirm:
...
{% hint style="info" %}
If a trap shows as unsubscribed, or a plan you expect isn't listed on your account Billing page, **don't start a new subscription.** [Contact support](../support/support.md), and we'll reconcile it so you won't be double-charged.
{% endhint %}

### 5. Get familiar: what's new

The new app keeps everything the old one did and adds a lot more. A few names and screens have changed. Skim the short guide below so nothing looks unfamiliar:

* **[What's new: old app vs. new app](whats-new.md):** a quick side-by-side of the terms and screens that changed.

When you first sign in, the app also offers a short guided tour that points out the main screens and controls. You can replay it any time from the help menu.
