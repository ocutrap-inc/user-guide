---
description: >-
  Go from unboxing to your first armed trap, with every step in order and links to
...
2. Charge the **blue battery** until the charger light turns **green**. A full charge takes about **5 to 6 hours**.
...
{% hint style="warning" %}
If any part is missing or damaged, stop and contact [support@ocutrap.com](mailto:support@ocutrap.com) before continuing.
{% endhint %}
...
1. Create an account (or log in) at [app.ocutrap.com](https://app.ocutrap.com). Verify your email. The app requires this before you can activate a trap.
...
Where you put the trap and how you set the **capture distance** matter most. The camera and sensor are fixed inside the POD, so there's nothing to aim.
