...
6. Run a complete [Open and Close cycle in the app](../app/open-closed-button.md), or use the physical buttons. Watch for the brief reverse followed by the second close.
