...
**Use the [LED Guide](../getting-started/led-guide.md)** — one place for every color and pattern, including the interactive diagnostic (pick the color you see, then how it's blinking).
