...
<!-- REVIEWER (optional): If OcuTrap enforces a specific automatic retention window (e.g.,
     images auto-deleted after N months), stores data in a specific region, or offers a data
     export, add those specifics to the Data Retention section above. As written, it defers to
     the Privacy Policy, which is the safe default. -->
