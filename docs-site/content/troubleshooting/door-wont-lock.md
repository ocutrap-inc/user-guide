---
description: What a properly locked OcuTrap door looks like, how to check it, and what to do when the door rests on top of the locking bar.
---

# Door won't lock behind the locking bar
