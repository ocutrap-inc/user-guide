---
description: >-
  How to permanently remove a trap from your OcuTrap account in the web app,
...
{% hint style="danger" %}
**Warning:** This action is permanent and cannot be undone. Removing a trap deletes its images, activity history, and vitals history. Anyone the trap was shared with also loses access.
{% endhint %}
...
* The physical trap itself is unaffected. It can be added to another OcuTrap account later. If you're handing it to a new owner, follow [selling-or-transferring-a-trap.md](selling-or-transferring-a-trap.md "mention").
