...
Set the trap's mode to **Off**, **Scout**, or **Armed** from the **arm-mode dropdown** at the top of the trap's **Controls** card. The dropdown explains each mode before you choose. Picking the mode the trap is already in does nothing.
