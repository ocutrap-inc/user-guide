---
description: >-
  Step-by-step help when your OcuTrap shows offline, will not connect, or does
...
Use the table below to interpret what the trap is doing. If the LED never turns on after a charged battery is connected and the power button is pressed, contact [OcuTrap Support](../support/support.md).
...
| Rapid red blinks | Firmware crash or system error | Count the blinks and contact Support |
...
If the trap remains offline after checking the battery, waking the device, and confirming cellular coverage, contact [OcuTrap Support](../support/support.md) with the details above so we can review the device status and help determine the next step.
