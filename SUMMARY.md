...
* [OcuTrap Knowledge Base](README.md)

## Getting started

* [Setup](getting-started/setup.md)
  * [Set up your trap](getting-started/set-up-tutorial.md)
  * [Set up your OcuTrap R2](getting-started/setting-up-r2.md)
  * [Hardware set up (OcuTrap R1)](getting-started/setting-up.md)
...
* [Daily use](getting-started/daily-use.md)
  * [App](getting-started/app/README.md)
    ...
    * [Requesting photos](getting-started/app/requesting-photos.md)
    * [After a capture](getting-started/app/after-capture.md)
    * [Settings in the app](getting-started/app/trap-settings/README.md)
    ...
    * [Sharing traps](getting-started/app/sharing-traps/README.md)
      * [User levels](getting-started/app/sharing-traps/user-levels.md)
  ...
  * [Door and capture features](getting-started/capture-behavior/README.md)
    * [Enhanced door closing](getting-started/capture-behavior/enhanced-door-closing.md)
    * [Pre-capture notification](getting-started/capture-behavior/pre-capture-notification.md)
    * [Distance limits, sensor alerts and errors](getting-started/capture-behavior/distance-safety-and-alerts.md)
* [Reference](getting-started/reference.md)
  ...
  * [Accessory port](getting-started/accessory-port.md)
...
* [GPS](faqs/gps.md)
* [Weather and environmental guidelines](faqs/weather-and-environmental-guidelines.md)
...
* [Safe-mode](troubleshooting/safe-mode.md)
* [Can't sign in to your account](troubleshooting/cant-sign-in.md)
* [Resetting the mobile app](troubleshooting/resetting-the-mobile-app.md)
...
* [Responsible and legal use](legal-and-compliance/responsible-and-legal-use.md)
* [Your data and privacy](legal-and-compliance/data-and-privacy.md)

## Device management

* [Deleting a trap](device-management/deleting-a-trap.md)
...
* [Changing your subscription payment method](account-and-billing/changing-your-subscription-payment-method.md)
* [Transferring trap billing to an organization](account-and-billing/transferring-trap-billing-to-an-organization.md)
* [Billing when you move to the new app](account-and-billing/billing-when-you-move-to-the-new-app.md)
